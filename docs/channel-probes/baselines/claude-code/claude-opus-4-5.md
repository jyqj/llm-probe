# Claude Code — claude-opus-4-5 基线
...
### precheck — 基线流式探针 [PARTIAL 0/18] (771ms)
...
### tag_replay — 全量指纹探针 [PARTIAL 0/23] (843ms)
...
### mini_probe — 极简非流式探针 [PARTIAL 0/7] (345ms)
...
### identity_probe — 身份识别探针 [PARTIAL 0/15] (497ms)
...
### self_intro — 结构化自述探针 [PARTIAL 0/7] (392ms)
...
### tool_use — 工具调用探针 [PARTIAL 0/8] (310ms)
...
### logic — 逻辑推理探针 [PARTIAL 0/2] (388ms)
...
### hidden_prompt — 隐藏 Prompt 检测 [PARTIAL 0/2] (321ms)
...
### image_ocr — 图片 OCR 探针 [PARTIAL 0/2] (378ms)
...
### pdf_extract — PDF 提取探针 [PARTIAL 0/2] (389ms)
...
### magic_refusal — 拒答字符串探针 [PARTIAL 0/2] (309ms)
...
### effort_thinking — Effort 级别思考探针 [PARTIAL 0/4] (938ms)

| Check | 状态 | 实际值 | 详情 |
|---|---|---|---|
| `effort_high_thinking` | FAIL | 请求失败 | HTTP 503 (api_error): No available accounts: no available accounts |
| `effort_high_signature` | FAIL | 请求失败 | HTTP 503 (api_error): No available accounts: no available accounts |
| `effort_medium_no_think` | FAIL | 请求失败 | HTTP 503 (api_error): No available accounts: no available accounts |
| `effort_low_no_think` | FAIL | 请求失败 | HTTP 503 (api_error): No available accounts: no available accounts |

### signature_reject — 空签名拒绝探针 [PARTIAL 0/1] (312ms)

| Check | 状态 | 实际值 | 详情 |
|---|---|---|---|
| `signature_empty_rejected` | FAIL | 503 | 状态码 503, 期望 400 |

### bash_tool — Bash 工具探针 [PARTIAL 0/3] (629ms)
...
### minimal_tokens — 最小 Token 计费探针 [PARTIAL 0/3] (308ms)
...
| `effort_high_thinking` | HTTP 503 (api_error): No available accounts: no available accounts |
| `effort_high_signature` | HTTP 503 (api_error): No available accounts: no available accounts |
| `effort_medium_no_think` | HTTP 503 (api_error): No available accounts: no available accounts |
| `effort_low_no_think` | HTTP 503 (api_error): No available accounts: no available accounts |
| `signature_empty_rejected` | 状态码 503, 期望 400 |
